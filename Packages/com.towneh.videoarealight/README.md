...
For deeper guidance — sizing recipes, voxel-size tradeoffs, memory tables — see [`Documentation~/Occlusion.md`](Documentation~/Occlusion.md).
...
**Full guide:** [`Documentation~/PoiyomiIntegration.md`](Documentation~/PoiyomiIntegration.md) — covers the install flow, shader regeneration, Thry lock interaction, uninstall, and troubleshooting.
