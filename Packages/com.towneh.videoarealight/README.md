...
**Full guide:** [`Documentation~/PoiyomiIntegration.md`](Documentation~/PoiyomiIntegration.md) — covers the mental model (shader-scoped, not material-scoped), the confirmation dialog, locking interaction, uninstall, and troubleshooting.
